...
class CashReceipt extends BaseController
{
    ...
    public function ajaxListJson()
    {
        ...
        $receipts = $this->cashModel->getAllFilteredCashReceipts($search, $fromstart, $tolimit, $orderColumn, $order);
        ...
        foreach ($receipts as $row) {
            $data[] = [
                ...
                'customer_name' => $row['customer_name'], // Now shows actual name
                'payment_date' => date('d-m-Y', strtotime($row['invoice_date'])), // Format dd-mm-yyyy
